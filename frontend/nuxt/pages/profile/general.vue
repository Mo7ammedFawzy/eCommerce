...
<template>
  <main id='profile-general-page' class='mt-6 min-h-screen mb-16 md:mb-8'>
    <BaseWrapper>
      <BasePageHeader label="profile"/>
      <div class="grid grid-cols-3 gap-6 mt-8">
        <!-- upload-photo -->
        <div class="col-span-full md:col-span-1 semi-card-ring flex items-center">
          <div class="mx-auto max-w-xs flex flex-col items-center justify-center text-center">
            <div
                class="circle-dotted w-40 aspect-square  rounded-full border-dashed border-gray-400 dark:border-gray-600 p-3 border">
              <input accept="image/*" @change="onImageChange" type="file" class="hidden" id="upload-file"/>
              <label for="upload-file" type="file"
                ...
                <span class="absolute flex items-center justify-center top-0 right-0 aspect-square rounded-full"
                     v-if="canShowImg">
                  <span
        ...
        <!-- user-info -->
        <div class="col-span-full md:col-span-2 semi-card-ring">
