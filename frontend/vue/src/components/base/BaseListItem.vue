...
<template>
  <RouterLink :to="`/products/${product.id}`"
    ...
    <div class="md:!h-auto w-18 bg-white rounded-full md:w-20 aspect-square p-3 md:p-2.5">
      <img :src="product.images" class="rounded-lg aspect-auto max-h-full w-full object-contain" :alt="product.title" loading="lazy"/>
    </div>
    <div class="max-w-[50%]">
      <div v-text="product.title" class="three-dots"/>
    </div>
  </RouterLink>
</template>
