...
<template>
 <section id='top-collections' class='my-10'>
  <BaseHeader title="top collections" class="" />
  <!-- products -->
  ...
  <BaseProductWrapper :products="Products" />
  <!-- <div> -->
  <UButton size="xl" color="primary" variant="solid" :trailing="true" class="px-6 btn-primary flex mx-auto w-fit"
